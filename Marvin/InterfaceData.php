...
/* 
***	File for arbitrary interfaces into other things.
*/

/*
*   Get nowplaying data from VLC HTTP JSON status page.
...
if (isset($_GET["nowplaying"]))
{
	...
	// VLC contents supercedes file contents if both are enabled.
